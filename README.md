...
![node](https://github.com/user-attachments/assets/376c45ab-a68e-4d9a-9d43-aea4d6ebe137)


特别申明：本插件的所有节点均由AI开发，提供者（@幻影）不懂代码，如不好用或有BUG请删除。
...
#视频首尾帧获取
· 支持两种输入方式：
      1、直接输入视频文件路径（mp4/avi/mov/mkv/flv）；
